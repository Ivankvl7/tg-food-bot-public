...
basic_menu: dict = {
    ...
    "turn_on_admin_mode": "Включить режим администратора"
...
command_handlers: dict = {
    ...
    "payment": "После подтверждение заказа с вами свяжется менеджера магазина и вы вместе с вами подберет подходящий метод оплаты",

    "delivery": "После подтверждение заказа с вами свяжется менеджера магазина и уточнит желаемый метод доставки. \n"
                "В среднем срок доставки составляет 10-15 дней",
